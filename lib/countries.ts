/**
 * ISO 3166-1 alpha-2 country list used by the input form dropdowns.
 * Scoped to the ~200 sovereign / widely-recognized countries — the same set
 * IATA Timatic uses for visa rules. Sort order is alphabetical by name.
 */
